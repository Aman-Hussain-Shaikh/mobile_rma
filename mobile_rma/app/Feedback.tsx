                        ...
                        <View style={styles.radioContainer}>
                            ...
                            <View style={styles.radioGroup}>
                                <View style={styles.radioButton}>
                                    <RadioButton
                                        value="yes"
                                        status={complaintResolved === 'yes' ? 'checked' : 'unchecked'}
                                        onPress={() => setComplaintResolved('yes')}
                                        color="#1F486B"
                                    />
                                ...
                                <View style={styles.radioButton}>
                                    <RadioButton
                                        value="no"
                                        status={complaintResolved === 'no' ? 'checked' : 'unchecked'}
                                        onPress={() => setComplaintResolved('no')}
                                        color="#1F486B"
                                    />
                                ...
                                {['Average', 'Good', 'Excellent', 'Not Good'].map((option) => (
                                    <View key={option} style={styles.radioButton}>
                                        <RadioButton
                                            ...
                                            status={satisfaction === option.toLowerCase() ? 'checked' : 'unchecked'}
                                            onPress={() => setSatisfaction(option.toLowerCase())}
                                            color="#1F486B"
                                        />
                            ...
                            <View style={styles.radioGroup}>
                                {['Always', 'Not Sure', 'Never'].map((option) => (
                                    <View key={option} style={styles.radioButton}>
                                        <RadioButton
                                            value={option.toLowerCase()}
                                            status={recommendation === option.toLowerCase() ? 'checked' : 'unchecked'}
                                            onPress={() => setRecommendation(option.toLowerCase())}
                                            color="#1F486B"
                                        />
                                        <Text style={styles.radioLabel}>{option}</Text>
                                    </View>
